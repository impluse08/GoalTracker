             ...
             {/* //  horizontal line  */}
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <input type="text" id="password" className=" border border-gray-600 text-gray-900  bg-gray-700 rounded-lg focus:ring-blue-500 focus:border-blue-500 block py-2 px-1 ml-4 w-88 h-11"  placeholder="AGCTF#%3245SFG" value={formData.password} onChange={handleChange} required/>
                    </div>
                  </div>
                ...
                <div className='ml-12'>
                  ...
                  <div className='w-80'><input className="block w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-300 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-300" id="avatar" type="file" /></div>
